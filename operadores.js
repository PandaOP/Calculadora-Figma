...
function getOutput(){
	return document.getElementById("pantalla-result").innerText;
}
function printOutput(num){
	if(num==""){
		document.getElementById("pantalla-result").innerText=num;
	}
	else{
		document.getElementById("pantalla-result").innerText=getFormattedNumber(num);
	}	
}
